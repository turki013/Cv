...
#align(center)[
  ...
  #v(0.3em)
  #text(size: 9pt)[
    Riyadh, Saudi Arabia | 0550494319 | turki.n.almutairi\@outlook.com \
...
#v(-0.4em)
#line(length: 100%, stroke: 0.5pt + gray)
*Bachelor in Data Science* | Saudi Electronic University #h(1fr) 2023 -- 2027 \
Riyadh, Saudi Arabia
...
// Projects Section
#text(weight: "bold", size: 11pt)[PROJECTS]
#v(-0.4em)
#line(length: 100%, stroke: 0.5pt + gray)
...
#text(weight: "bold", size: 11pt)[CERTIFICATES]
#v(-0.4em)
#line(length: 100%, stroke: 0.5pt + gray)
- Data Analysis
- Saudi GenAI Hero - Mandatory
- AI: Impact, Considerations, and Ethical Issues (HICA AI)
- Udacity AI Specialist
...
#text(weight: "bold", size: 11pt)[ORGANISATIONS]
#v(-0.4em)
#line(length: 100%, stroke: 0.5pt + gray)
